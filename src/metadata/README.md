 ...
 * [exmo.yml](exmo.yml)
     * Determines how your purl.obolibrary.org/obo/exmo/ redirects will be handled
     ...
     * Paste in the contents of [exmo.yml](exmo.yml)
 ...
 * [exmo.md](exmo.md)
     ...
     * Paste in the contents of [exmo.md](exmo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
